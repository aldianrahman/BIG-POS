...
/**
 * Menyusun & mencetak struk transaksi gantung yang ringkas (kasir, tanggal,
 * keterangan) + QR berisi id. Best-effort: tidak pernah melempar; kegagalan
 * dikembalikan sebagai [HoldPrintResult] agar proses menggantung tetap berhasil.
 */
@Singleton
